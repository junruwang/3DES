...
public class Util 
{
    ...
    /**
     * 灏嗗崄鍏繘鍒跺瓧绗﹁浆鎹㈡垚涓�釜鏁存暟
     *
     * @param ch    鍗佸叚杩涘埗char
     * @param index 鍗佸叚杩涘埗瀛楃鍦ㄥ瓧绗︽暟缁勪腑鐨勪綅缃�
     * @return 涓�釜鏁存暟
     * @throws RuntimeException 褰揷h涓嶆槸涓�釜鍚堟硶鐨勫崄鍏繘鍒跺瓧绗︽椂锛屾姏鍑鸿繍琛屾椂寮傚父
     */
    ...
    /**
     * 瀛楄妭鏁扮粍杞负鏅�瀛楃涓诧紙ASCII瀵瑰簲鐨勫瓧绗︼級
     * 
     * @param bytearray
     *            byte[]
     * @return String
    ...
    /**
     * HEX瀛楃涓插墠琛�锛屼富瑕佺敤浜庨暱搴︿綅鏁颁笉瓒炽�
     * 
     * @param str
     *            String 闇�琛ュ厖闀垮害鐨勫崄鍏繘鍒跺瓧绗︿覆
     * @param maxLength
     ...
     * @param radix
     *            int 瑕佽浆鎹㈢殑瀛楃涓叉槸浠�箞杩涘埗鐨�濡�6 8 10.
